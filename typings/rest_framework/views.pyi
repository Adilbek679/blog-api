...
def get_view_description(view, html=...):
    """
...
class APIView(View):
    ...
    def perform_content_negotiation(self, request, force=...): # -> ... | tuple[..., ...]:
        """
    ...
    def determine_version(self, request, *args, **kwargs): # -> tuple[None, None] | tuple[..., ...]:
        """
